...
uchar NAME(scancodetable)[] = {
 ...
 /* 1 */ PUNCT_ALTGR	(0x02, '1',  '!',       0xFB  )		// DIGIT ONE, EXCLAMATION MARK, SUPERSCRIPT ONE
 /* 2 */ PUNCT_ALTGR	(0x03, '2',  '"',       0xFD  )		// DIGIT TWO, QUOTATION MARK, SUPERSCRIPT TWO
#ifdef COMBI
 /* 3 */ PUNCT_ALTGR	(0x04, '3',  COMBI1,    '#'   )		// DIGIT THREE, CIRCUMFLEX ACCENT, NUMBER SIGN
#else
 /* 3 */ PUNCT_ALTGR	(0x04, '3',  '^',       '#'   )		// DIGIT THREE, CIRCUMFLEX ACCENT, NUMBER SIGN
#endif
 /* 4 */ PUNCT_ALTGR	(0x05, '4',  '$',       0xAC  )		// DIGIT FOUR, DOLLAR SIGN, VULGAR FRACTION ONE QUARTER
 ...
 /* - */ PUNCT_ALTGR	(0x0c, '/',  '?',       '\\'  )		// SOLIDUS, QUESTION MARK, REVERSE SOLIDUS
 ...
 /* R */ ALPHA_ALTGR	(0x13, 0x8D, 'I',       0xF4  )		// LATIN SMALL LETTER DOTLESS I, LATIN CAPITAL LETTER I, PILCROW SIGN
 ...
 /* O */ ALPHA		(0x18, 'h',  'H'	      )		// LATIN SMALL LETTER H, LATIN CAPITAL LETTER H
 ...
 /* A */ ALPHA		(0x1e, 'u',  'U'              )		// LATIN SMALL LETTER U, LATIN CAPITAL LETTER U
 /* S */ ALPHA_ALTGR	(0x1f, 'i',  0x98,      0xE1  )		// LATIN SMALL LETTER I, LATIN CAPITAL LETTER I WITH DOT ABOVE, LATIN SMALL LETTER SHARP S
 /* D */ ALPHA_ALTGR	(0x20, 'e',  'E',       0xD5  )		// LATIN SMALL LETTER E, LATIN CAPITAL LETTER E, EURO SIGN
 /* F */ ALPHA		(0x21, 'a',  'A'              )		// LATIN SMALL LETTER A, LATIN CAPITAL LETTER A
 ...
 /* \ */ PUNCT_ALTGR	(0x56, '<',  '>',      '|'    )		// LESS-THAN SIGN, GREATER-THAN SIGN, VERTICAL LINE

 /* Z */ ALPHA_ALTGR	(0x2c, 'j',  'J',       0xAE  )		// LATIN SMALL LETTER J, LATIN CAPITAL LETTER J, LEFT-POINTING DOUBLE ANGLE QUOTATION MARK
 /* X */ ALPHA_ALTGR	(0x2d, 0x94, 0x99,      0xAF  )		// LATIN SMALL LETTER O WITH DIAERESIS, LATIN CAPITAL LETTER O WITH DIAERESIS, RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
 /* C */ ALPHA_ALTGR	(0x2e, 'v',  'V',       0XBD  )		// LATIN SMALL LETTER V, LATIN CAPITAL LETTER V, CENT SIGN
 ...
 /* M */ ALPHA_ALTGR	(0x32, 's',  'S',	0xE6  )		// LATIN SMALL LETTER S, LATIN CAPITAL LETTER S, MICRO SIGN
